...
def main():
    ...
    end_date = dt.datetime(2011, 1, 10)
...
#                max_allocation = allocation 
    allocation = [0.2, 0.3, 0.4, 0.1]    
    (daily_return_stddev, average_daily_return, sharpe_ratio, cum_return) = simulateNoCapital(start_date, end_date, symbols, allocation)
    print start_date
    print end_date
    print symbols
    print allocation
